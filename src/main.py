...
def _generate_cycle(press, bench_press, squat, deadlift):
  url = (f'https://blackironbeast.com/5/3/1/calculator?'
          'assistanceWork=boringButBig&massUnits=pounds&maxesSwitch=trainingMax'
          '&militaryTrainingMaxWeight={press}&benchTrainingMaxWeight={bench_press}&squatTrainingMaxWeight={squat}&deadliftTrainingMaxWeight={deadlift}'
...
def main():
  weeks = _generate_cycle(120, 210, 240, 280)
